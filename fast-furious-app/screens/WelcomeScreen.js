...
const styles = StyleSheet.create({
    ...
    title: { fontFamily: "Nosifer-Regular", fontSize: 22, color: "#F8F8FF", textAlign: "center", marginBottom: 6, fontWeight: "bold" },
    paragraph: { fontFamily: "NewRocker-Regular", fontSize: 14, color: "#E0D9D9", lineHeight: 20, textAlign: "left" },
    ...
    btnSignInText: { fontFamily: "NewRocker-Regular", color: "#F8F8FF", fontWeight: "bold", fontSize: 16 },
    ...
    btnSignUpText: { fontFamily: "NewRocker-Regular", color: "#FF8800", fontWeight: "bold", fontSize: 16 },
});