...
const styles = StyleSheet.create({
    ...
    cardTitle: { fontFamily: "Nosifer-Regular", fontSize: 20, color: "#FF8800", fontWeight: "bold", marginBottom: 20 },
    ...
    btnSignUpText: { fontFamily: "NewRocker-Regular", color: "#FF8800", fontWeight: "bold" },
