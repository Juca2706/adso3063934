...
<div class="join mx-auto">
    ...
    <a class="btn btn-outline btn-success join-item" href="{{ url('import/users/excel') }}">
        <svg xmlns="http://www.w3.org/2000/svg" class="size-6" fill="currentColor" viewBox="0 0 256 256">
            <path
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr @if($user->id % 2 == 0) class="bg-[#0006]" @endif>
                ...
                <td>
                    <a href="{{ url('users/'. $user->id) }}" class="btn  btn-outline btn-accent btn-xs rounded-full p-3 mb-1">
                    ...
                    <a href="{{ url('users/'. $user->id. '/edit') }}" class="btn btn-outline btn-warning btn-xs rounded-full p-3 mb-1">
                    ...
                    <a href="javascript:;" class="btn btn-outline btn-error btn-xs rounded-full p-3 mb-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="size-5" fill="currentColor" viewBox="0 0 256 256">
                            <path
