...
@section('title', 'Edit Pets: Larapets 🐻‍❄️')
...
<div class="card text-white md:w-[720px] w-[320px] bg-[#0006] p-7 rounded-md">
    ...
    <form method="POST" action="{{ url('pets/'.$pet->id) }}" class="flex flex-col md:flex-row gap-4 mt-4"
        ...
        <div class="w-full md:w-[320px]">
            ...
            <input type="text" class="input bg-[#0009]" name="name" placeholder="Firulais"
            ...
            <select name="kind" class="select bg-[#0009]">
                ...
                <option value="Parrot" @if(old('kind', $pet->kind)=='Parrot' ) selected @endif>Parrot</option>
            </select>
            @error('kind')
            <small class="badge badge-error w-full mt-1 text-xs py-4">
                <svg class="size-[1em]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            ...
            <input type="number" class="input bg-[#0009]" name="weight" step="any" placeholder="2.5"
            ...
            <input type="number" class="input bg-[#0009]" name="age" placeholder="4"
        ...
        <div class="w-full md:w-[320px] text-white">
            ...
            <select name="status" class="select bg-[#0009]">
                ...
                <option value="1" @if(old('active', $pet->status)== 1) selected @endif>Adopted</option>
            </select>
            @error('status')
            <small class="badge badge-error w-full mt-1 text-xs py-4">
                <svg class="size-[1em]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
